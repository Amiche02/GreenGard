...
def main():
    # Load the YOLO model
    model = YOLO('Plant_disease_model/best_95.pt')

    # Define the directory where the custom images are stored
    custom_image_dir = 'data/Powdery-Mildew-on-a-Tomato-Plant.jpg'
    ...
    detect_img, classes = plant_disease_detect(custom_image_dir, model)
